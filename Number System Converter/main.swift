...
// Existing Functions
// Change the decimal number to the same value within the stated "to" number system.
...
// Function to change the number from any number system into decimal.
...
// INPUT
// (Comments should describe intent)
...
// Gets user input and changes it to uppercase.
let from = readLine()!
...
// Switch statements for the "from base"
// Creating a variable for the output where the number system the number came from is shown.
var fromBaseSystem = "From"
// A variable that holds the numeric value of the number base chosen.
...
// Switch statements for the "to base"
// A variable that holds the numeric value of the number base chosen.
var toBaseNumber = 0
// Creating a variable for the output where the number system the number came from is shown.
var toBaseSystem = "To"
...
// Creating a constant that uses the function below (toDecimal) and holds the value of the converted number in decimal.
let decimalNumber = toDecimal(number: numberToConvert, from: fromBaseNumber)

// Creating a constant that uses the function below (getRepresentation) and shows the numeric value of the number within the newest number system.
let output = getRepresentation(of: decimalNumber, in: toBaseNumber)

// OUTPUT
// The prompt that is shown to the user.
